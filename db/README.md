...
| **`seed/`** | **开发/测试种子数据**（如默认管理员、科目样例）；**勿**把生产密钥提交进仓库。教材目录示例：`seed/textbook_yuedu_physics_required_2019.sql`（粤教版 2019 物理必修；需先建表并建议执行 `2026-04-08#02_…`，使 `chapter`/`section` 含 `status` 且无序号唯一约束，与当前基线一致）。 |
