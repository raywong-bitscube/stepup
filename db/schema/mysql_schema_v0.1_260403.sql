...
CREATE TABLE IF NOT EXISTS ai_model (
  ...
  model VARCHAR(255) NOT NULL COMMENT 'OpenAI-compatible chat model id (e.g. kimi-k2.5)',
...
-- =====================================
-- 15) textbook / chapter / section（教材目录：书-章-节）
-- =====================================
CREATE TABLE IF NOT EXISTS textbook (
  ...
  subject_id BIGINT UNSIGNED NULL COMMENT '可选，关联 subject.id',
  status TINYINT(1) NOT NULL DEFAULT 1 COMMENT '1=active,0=inactive',
...
CREATE TABLE IF NOT EXISTS chapter (
  ...
  number INT UNSIGNED NOT NULL COMMENT '章序号，从 1 起',
  ...
  KEY idx_chapter_textbook_number (textbook_id, number),
...
CREATE TABLE IF NOT EXISTS section (
  ...
  KEY idx_section_chapter_number (chapter_id, number),
