...
**关联**: [文档索引](../README.md)、[部署指南 §3.7 / §8](../core/deployment_guide_v0.1_260403.md)、[`backend/README.md`](../../backend/README.md)、[`deploy/nginx_go_static_split_ports.conf.example`](../../deploy/nginx_go_static_split_ports.conf.example)
...
| **Nginx 示例** | 仓库 **[`deploy/nginx_go_static_split_ports.conf.example`](../../deploy/nginx_go_static_split_ports.conf.example)**：`7010` / `7011` 静态、`7012` 反代、`client_max_body_size` 与超时利于试卷上传；部署前修改其中 **`root` / `upstream`** 端口。 |
