...
**建议入口**：发往测试 / 预发请先读 [**releases/DEPLOY_AND_UPGRADE_v0.1_260404.md**](./releases/DEPLOY_AND_UPGRADE_v0.1_260404.md)，再按需展开 **core** 中文档。
...
| 你想… | 建议阅读 |
|--------|-----------|
| **把本版本发到测试 / 预发** | [releases/DEPLOY_AND_UPGRADE…](./releases/DEPLOY_AND_UPGRADE_v0.1_260404.md) → [core/部署指南](./core/deployment_guide_v0.1_260403.md) |
...
详细命令与排错见 [core/部署指南](./core/deployment_guide_v0.1_260403.md) 与 [releases/升级说明](./releases/DEPLOY_AND_UPGRADE_v0.1_260404.md)。
