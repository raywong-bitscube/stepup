...
- 教材目录（粤教版 2019 物理必修一/二）为 **可选**：迁移建好 `textbook` / `textbook_chapter` / `textbook_section` 后（已建库环境请执行 `db/migrations/2026-04-12#01_rename_textbook_chapter_section.sql` 或等价 PG 脚本），可执行 `db/seed/textbook_yuedu_physics_required_2019.sql`（详见 [`releases/20260408#01`](../releases/20260408%2301_DEPLOY_AND_UPGRADE.md)）。
